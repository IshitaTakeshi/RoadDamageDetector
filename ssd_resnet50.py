import chainer
from chainer.links import Linear, ResNet50Layers
...
class ResNet50Extractor(ResNet50Layers):
    ...
    def __call__(self, x):
        ...
        activations = super(ResNet50Extractor, self).__call__(x, layers)
...
class SSD224(SSD):
    ...
    This model uses :class:`ResNet50Extractor` as its feature extractor.
    ...
    Args:
       ...
       pretrained_extractor (str): The `npz` weight file of `ResNet50Layers`.
    ...
    def __init__(self, n_fg_class=None,
        ...
        super(SSD224, self).__init__(
            extractor=ResNet50Extractor(pretrained_extractor),
            multibox=Multibox(
